...
contract SyncRedeemTest is BaseTest {
    ...
    function test_syncRedeem_revertsWhenClassIdIsInvalid() public {
        ...
        vault.syncRedeem(
            IAlephVaultRedeem.RedeemRequestParams({classId: 0, estAmountToRedeem: 50 ether})
        );
    }
    ...
    function test_syncRedeem_revertsWhenAmountIsZero() public {
        ...
        vault.syncRedeem(
            IAlephVaultRedeem.RedeemRequestParams({classId: 1, estAmountToRedeem: 0})
        );
    }
    ...
    function test_syncRedeem_revertsWhenInsufficientUserAssets() public {
        ...
        vm.expectRevert(IAlephVaultRedeem.InsufficientAssetsToRedeem.selector);
        vault.syncRedeem(
            IAlephVaultRedeem.RedeemRequestParams({classId: 1, estAmountToRedeem: 200 ether})
        );
    }
    ...
    function test_syncRedeem_revertsWhenUserInLockInPeriod() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IAlephVaultRedeem.UserInLockInPeriodNotElapsed.selector, _lockInPeriodBatch
            )
        );
        vault.syncRedeem(
            IAlephVaultRedeem.RedeemRequestParams({classId: 1, estAmountToRedeem: _redeemAmount})
    ...
    function test_syncRedeem_clearsLockInPeriodWhenRedeemingAll() public {
        ...
        vm.prank(mockUser_1);
        vault.syncRedeem(
            IAlephVaultRedeem.RedeemRequestParams({classId: 1, estAmountToRedeem: _totalAssets})
        );
