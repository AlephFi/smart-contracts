...
contract AlephVaultRedeemTest is BaseTest {
    ...
    function test_requestRedeem_revertsWhenClassIdIsInvalid() public {
        ...
        IAlephVaultRedeem.RedeemRequestParams memory params =
            IAlephVaultRedeem.RedeemRequestParams({classId: 0, shareRequests: new IAlephVaultRedeem.ShareRequest[](1)});
        params.shareRequests[0] = IAlephVaultRedeem.ShareRequest({seriesId: 0, shares: 100});
    ...
    function test_requestRedeem_revertsGivenAmountToRedeemIsZero() public {
        ...
        IAlephVaultRedeem.RedeemRequestParams memory params =
            IAlephVaultRedeem.RedeemRequestParams({classId: 1, shareRequests: new IAlephVaultRedeem.ShareRequest[](1)});
        params.shareRequests[0] = IAlephVaultRedeem.ShareRequest({seriesId: 0, shares: 0});
        vault.requestRedeem(params);
    }
        ...
        public
    {
        ...
        IAlephVaultRedeem.RedeemRequestParams memory params_user1 =
            IAlephVaultRedeem.RedeemRequestParams({classId: 1, shareRequests: new IAlephVaultRedeem.ShareRequest[](1)});
        params_user1.shareRequests[0] = IAlephVaultRedeem.ShareRequest({seriesId: 0, shares: 100 ether});
        vm.prank(mockUser_1);
        vm.expectEmit(true, true, true, true);
        emit IAlephVaultRedeem.RedeemRequest(mockUser_1, 1, _shareUnits, _expectedBatchId);
        ...
        IAlephVaultRedeem.RedeemRequestParams memory params_user2 =
            IAlephVaultRedeem.RedeemRequestParams({classId: 1, shareRequests: new IAlephVaultRedeem.ShareRequest[](1)});
        params_user2.shareRequests[0] = IAlephVaultRedeem.ShareRequest({seriesId: 0, shares: 150 ether});
        vm.prank(mockUser_2);
        vm.expectEmit(true, true, true, true);
