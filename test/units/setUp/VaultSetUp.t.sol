...
contract VaultSetUpTest is BaseTest {
    ...
    function test_constructor_when_alephVaultDepositImplementation_passed_is_address_0() public {
        vm.expectRevert(AlephVaultBase.InvalidConstructorParams.selector);
        new ExposedVault(
    ...
    function test_constructor_when_alephVaultRedeemImplementation_passed_is_address_0() public {
        vm.expectRevert(AlephVaultBase.InvalidConstructorParams.selector);
        new ExposedVault(
            IAlephVault.ConstructorParams({
    ...
    function test_constructor_when_alephVaultSettlementImplementation_passed_is_address_0() public {
        vm.expectRevert(AlephVaultBase.InvalidConstructorParams.selector);
        new ExposedVault(
            IAlephVault.ConstructorParams({
                alephVaultDepositImplementation: makeAddr("AlephVaultDeposit"),
    ...
    function test_constructor_when_feeManagerImplementation_passed_is_address_0() public {
        vm.expectRevert(AlephVaultBase.InvalidConstructorParams.selector);
        new ExposedVault(
            IAlephVault.ConstructorParams({
                alephVaultDepositImplementation: makeAddr("AlephVaultDeposit"),
    ...
    function _setDefaultVault() internal {
