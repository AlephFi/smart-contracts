...
//             feeRecipientTimelock: defaultConfigParams.feeRecipientTimelock,
//             batchDuration: defaultConfigParams.batchDuration
//         });
...
//         vault = new ExposedVault(defaultConfigParams);

//         assertEq(vault.minDepositAmountTimelock(), defaultConfigParams.minDepositAmountTimelock);
//         assertEq(vault.maxDepositCapTimelock(), defaultConfigParams.maxDepositCapTimelock);
//         assertEq(vault.managementFeeTimelock(), defaultConfigParams.managementFeeTimelock);
//         assertEq(vault.performanceFeeTimelock(), defaultConfigParams.performanceFeeTimelock);
//         assertEq(vault.feeRecipientTimelock(), defaultConfigParams.feeRecipientTimelock);
//         assertEq(vault.BATCH_DURATION(), defaultConfigParams.batchDuration);
//     }
