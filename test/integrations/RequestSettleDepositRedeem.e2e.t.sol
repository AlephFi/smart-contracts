...
contract RequestSettleDepositRedeemTest is BaseTest {
    ...
    function test_requestSettleDeposit_requestSettleRedeem() public {
        ...
        params.estAmountToRedeem = 200 ether;
        vm.prank(mockUser_2);
        vault.requestRedeem(params);
        ...
        uint256 _expectedPerformanceShares = vault.getPerformanceFeeShares(
            _settlementParams.newTotalAssets[0], _totalShares + _expectedManagementShares
        );
    ...
    function test_requestSettleDeposit_requestSettleRedeem_multipleBatches() public {
        ...
        // request redeem
        IAlephVaultRedeem.RedeemRequestParams memory params =
            IAlephVaultRedeem.RedeemRequestParams({classId: 1, estAmountToRedeem: 300 ether});
        vm.prank(mockUser_1);
        vault.requestRedeem(params);
        params.estAmountToRedeem = 400 ether;
        vm.prank(mockUser_2);
        vault.requestRedeem(params);
