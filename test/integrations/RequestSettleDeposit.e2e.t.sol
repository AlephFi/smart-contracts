...
contract RequestSettleDepositTest is BaseTest {
    ...
    function test_requestDeposit_settleDeposit_whenNewTotalAssetsIsZero() public {
        ...
        uint48 _depositBatchId = vault.requestDeposit(_depositAmount, kycAuthSignature_1);
        vm.stopPrank();
    ...
    function test_requestDeposit_settleDeposit_multipleBatches() public {
        ...
        vm.prank(mockUser_1);
        vault.requestDeposit(100 ether, kycAuthSignature_1);
        vm.prank(mockUser_2);
        vault.requestDeposit(200 ether, kycAuthSignature_2);
        ...
        vm.prank(mockUser_1);
        vault.requestDeposit(200 ether, kycAuthSignature_1);
        vm.prank(mockUser_2);
        vault.requestDeposit(300 ether, kycAuthSignature_2);
        ...
        vm.prank(mockUser_1);
        vault.requestDeposit(300 ether, kycAuthSignature_1);
        vm.prank(mockUser_2);
        vault.requestDeposit(200 ether, kycAuthSignature_2);
