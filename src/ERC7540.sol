...
contract ERC7540 is IERC7540, AccessControlUpgradeable {
    ...
    function _initialize(InitializationParams calldata _initalizationParams) internal onlyInitializing {
        ...
        if (_initalizationParams.manager == address(0) ||
         ...
         _initalizationParams.communityMultisig == address(0) || 
        ...
        _sd.communityMultisig = _initalizationParams.communityMultisig;
        ...
        _sd.currentDepositSettleId = 1;
        _sd.lastDepositBatchIdSettled = 0;
        _sd.redeemBatchId = 1;
        _sd.redeemSettleId = 1;
        _sd.lastRedeemBatchIdSettled = 0;
    }
    ...
    function _requestDeposit(uint256 _amount) internal returns (uint40) {
        ...
        _sd.batchs[_currentDepositBatchId].depositRequest[msg.sender] += _amount;
