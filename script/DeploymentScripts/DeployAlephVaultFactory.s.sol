...
contract DeployAlephVaultFactory is BaseScript {
    ...
    function run() public {
        ...
        _initializationParams = IAlephVaultFactory.InitializationParams({
            ...
            kycAuthSigner: vm.parseJsonAddress(_config, string.concat(".", _chainId, ".", _environment, ".kycAuthSigner")),
        ...
        console.log("kycAuthSigner", _initializationParams.kycAuthSigner);
